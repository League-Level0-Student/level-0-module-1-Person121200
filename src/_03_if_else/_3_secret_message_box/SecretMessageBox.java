...
public class SecretMessageBox {
	...
	// 3. Now use a pop-up to tell the NEXT user that they can only see the secret message if they can guess the passcode
			JOptionPane.showMessageDialog(null, "You can only see the secret messgae if you put in the password");
	// 4. If their guess matches the password, show them the secret message
			String Intruder = JOptionPane.showInputDialog(null, "What is the Password");
	// 5. If the password does not match, pop-up "INTRUDER!!"
			if (Intruder.equals(Password)) {
